...
const titles: Record<string, string> = {
  ...
  '/profile/tasks': '任务中心',
  '/profile/points-mall': '积分商城',
  '/profile/activities': '活动中心',
  '/profile/market-mall': '行情商城',
  '/profile/rewards': '我的奖励',
  '/profile/coupons': '我的卡券',
  '/profile/anti-fraud': '反欺诈专区',
  '/profile/associated-account': '关联账户',
...
export default function Header() {
  ...
  const mainPaths = ['/', '/news', '/forum', '/classroom', '/portfolio', '/tools', '/profile']
